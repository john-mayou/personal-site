;(function (global, factory) {
  ...
  class RbAbiGuest {
    ...
    rbEvalStringProtect(arg0) {
      ...
      const len0 = UTF8_ENCODED_LEN
      const ret = this._exports[
        'rb-eval-string-protect: func(str: string) -> tuple<handle<rb-abi-value>, s32>'
      ](ptr0, len0)
      return [
        this._resource0_slab.remove(data_view(memory).getInt32(ret + 0, true)),
    ...
    rbFuncallvProtect(arg0, arg1, arg2) {
      ...
      ](this._resource0_slab.insert(obj0.clone()), to_uint32(arg1), result2, len2)
      return [
        this._resource0_slab.remove(data_view(memory).getInt32(ret + 0, true)),
        data_view(memory).getInt32(ret + 4, true),
      ]
    ...
    rstringPtr(arg0) {
      ...
      const obj0 = arg0
      if (!(obj0 instanceof RbAbiValue)) throw new TypeError('expected instance of RbAbiValue')
      const ret = this._exports['rstring-ptr: func(value: handle<rb-abi-value>) -> string'](
        this._resource0_slab.insert(obj0.clone())
      )
    ...
    rbSetShouldProhibitRewind(arg0) {
      const ret = this._exports['rb-set-should-prohibit-rewind: func(new-value: bool) -> bool'](
        arg0 ? 1 : 0
      )
      const bool0 = ret
      return bool0 == 0 ? false : bool0 == 1 ? true : throw_invalid_bool()
  ...
  function addRbJsAbiHostToImports(imports, obj, get_export) {
    ...
    imports['rb-js-abi-host'][
      'eval-js: func(code: string) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }'
    ...
    imports['rb-js-abi-host']['is-js: func(value: handle<js-abi-value>) -> bool'] = function (
      arg0
    ) {
    ...
    imports['rb-js-abi-host'][
      'instance-of: func(value: handle<js-abi-value>, klass: handle<js-abi-value>) -> bool'
    ] = function (arg0, arg1) {
    ...
    imports['rb-js-abi-host']['int-to-js-number: func(value: s32) -> handle<js-abi-value>'] =
      function (arg0) {
        const ret0 = obj.intToJsNumber(arg0)
        return resources0.insert(ret0)
      }
    imports['rb-js-abi-host']['float-to-js-number: func(value: float64) -> handle<js-abi-value>'] =
      function (arg0) {
        const ret0 = obj.floatToJsNumber(arg0)
        return resources0.insert(ret0)
      }
    imports['rb-js-abi-host']['string-to-js-string: func(value: string) -> handle<js-abi-value>'] =
      function (arg0, arg1) {
        const memory = get_export('memory')
        const ptr0 = arg0
        const len0 = arg1
    ...
    imports['rb-js-abi-host']['bool-to-js-bool: func(value: bool) -> handle<js-abi-value>'] =
      function (arg0) {
        const bool0 = arg0
        const ret0 = obj.boolToJsBool(bool0 == 0 ? false : bool0 == 1 ? true : throw_invalid_bool())
        return resources0.insert(ret0)
      }
    imports['rb-js-abi-host']['proc-to-js-function: func(value: u32) -> handle<js-abi-value>'] =
      function (arg0) {
        const ret0 = obj.procToJsFunction(arg0 >>> 0)
        return resources0.insert(ret0)
      }
    imports['rb-js-abi-host'][
      'rb-object-to-js-rb-value: func(raw-rb-abi-value: u32) -> handle<js-abi-value>'
    ] = function (arg0) {
      const ret0 = obj.rbObjectToJsRbValue(arg0 >>> 0)
      return resources0.insert(ret0)
    }
    imports['rb-js-abi-host']['js-value-to-string: func(value: handle<js-abi-value>) -> string'] =
      function (arg0, arg1) {
        const memory = get_export('memory')
    ...
    imports['rb-js-abi-host'][
      'js-value-to-integer: func(value: handle<js-abi-value>) -> variant { as-float(float64), bignum(string) }'
    ] = function (arg0, arg1) {
      const memory = get_export('memory')
      const realloc = get_export('cabi_realloc')
    ...
    imports['rb-js-abi-host']['export-js-value-to-host: func(value: handle<js-abi-value>) -> ()'] =
      function (arg0) {
        obj.exportJsValueToHost(resources0.get(arg0))
      }
    imports['rb-js-abi-host']['import-js-value-from-host: func() -> handle<js-abi-value>'] =
      function () {
        const ret0 = obj.importJsValueFromHost()
        return resources0.insert(ret0)
      }
    imports['rb-js-abi-host']['js-value-typeof: func(value: handle<js-abi-value>) -> string'] =
      function (arg0, arg1) {
        const memory = get_export('memory')
        const realloc = get_export('cabi_realloc')
    ...
    imports['rb-js-abi-host'][
      'js-value-equal: func(lhs: handle<js-abi-value>, rhs: handle<js-abi-value>) -> bool'
    ] = function (arg0, arg1) {
      const ret0 = obj.jsValueEqual(resources0.get(arg0), resources0.get(arg1))
      return ret0 ? 1 : 0
    }
    imports['rb-js-abi-host'][
      'js-value-strictly-equal: func(lhs: handle<js-abi-value>, rhs: handle<js-abi-value>) -> bool'
    ] = function (arg0, arg1) {
      const ret0 = obj.jsValueStrictlyEqual(resources0.get(arg0), resources0.get(arg1))
      return ret0 ? 1 : 0
    }
    imports['rb-js-abi-host'][
      'reflect-apply: func(target: handle<js-abi-value>, this-argument: handle<js-abi-value>, arguments: list<handle<js-abi-value>>) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }'
    ...
    imports['rb-js-abi-host'][
      'reflect-construct: func(target: handle<js-abi-value>, arguments: list<handle<js-abi-value>>) -> handle<js-abi-value>'
    ] = function (arg0, arg1, arg2) {
      const memory = get_export('memory')
      const len0 = arg2
      const base0 = arg1
    ...
    imports['rb-js-abi-host'][
      'reflect-delete-property: func(target: handle<js-abi-value>, property-key: string) -> bool'
    ] = function (arg0, arg1, arg2) {
      const memory = get_export('memory')
      const ptr0 = arg1
      const len0 = arg2
    ...
    imports['rb-js-abi-host'][
      'reflect-get: func(target: handle<js-abi-value>, property-key: string) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }'
    ...
    imports['rb-js-abi-host'][
      'reflect-get-own-property-descriptor: func(target: handle<js-abi-value>, property-key: string) -> handle<js-abi-value>'
    ] = function (arg0, arg1, arg2) {
      const memory = get_export('memory')
      const ptr0 = arg1
      const len0 = arg2
    ...
    imports['rb-js-abi-host'][
      'reflect-get-prototype-of: func(target: handle<js-abi-value>) -> handle<js-abi-value>'
    ] = function (arg0) {
      const ret0 = obj.reflectGetPrototypeOf(resources0.get(arg0))
      return resources0.insert(ret0)
    }
    imports['rb-js-abi-host'][
      'reflect-has: func(target: handle<js-abi-value>, property-key: string) -> bool'
    ] = function (arg0, arg1, arg2) {
      const memory = get_export('memory')
      const ptr0 = arg1
      const len0 = arg2
    ...
    imports['rb-js-abi-host']['reflect-is-extensible: func(target: handle<js-abi-value>) -> bool'] =
      function (arg0) {
        const ret0 = obj.reflectIsExtensible(resources0.get(arg0))
        return ret0 ? 1 : 0
      }
    imports['rb-js-abi-host'][
      'reflect-own-keys: func(target: handle<js-abi-value>) -> list<handle<js-abi-value>>'
    ] = function (arg0, arg1) {
      const memory = get_export('memory')
      const realloc = get_export('cabi_realloc')
    ...
    imports['rb-js-abi-host'][
      'reflect-prevent-extensions: func(target: handle<js-abi-value>) -> bool'
    ] = function (arg0) {
      const ret0 = obj.reflectPreventExtensions(resources0.get(arg0))
      return ret0 ? 1 : 0
    }
    imports['rb-js-abi-host'][
      'reflect-set: func(target: handle<js-abi-value>, property-key: string, value: handle<js-abi-value>) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }'
    ] = function (arg0, arg1, arg2, arg3, arg4) {
      const memory = get_export('memory')
      const ptr0 = arg1
      const len0 = arg2
    ...
    imports['rb-js-abi-host'][
      'reflect-set-prototype-of: func(target: handle<js-abi-value>, prototype: handle<js-abi-value>) -> bool'
    ] = function (arg0, arg1) {
  ...
  class RubyVM {
    ...
    static async instantiateModule(options) {
      ...
      ;(_b = options.setMemory) === null || _b === void 0
        ? void 0
        : _b.call(options, instance.exports.memory)
    ...
    constructor(binding) {
      ...
      this.guest = proxyExports(
        binding !== null && binding !== void 0 ? binding : new LegacyBinding()
      )
    ...
    static async _instantiate(options, initComponent) {
      ...
      const imports = vm.getImports(
        (from) => new JsAbiValue(from),
        (to) => to.underlying
      )
      const component = await initComponent(
        Object.assign(Object.assign({}, imports), {
          throwProhibitRewindException: (message) => {
    ...
    getImports(toJSAbiValue, fromJSAbiValue) {
      ...
      return proxyImports({
        ...
        reflectApply: wrapTry((target, thisArgument, args) => {
          ...
          return toJSAbiValue(
            Reflect.apply(fromJSAbiValue(target), fromJSAbiValue(thisArgument), jsArgs)
          )
        }),
        ...
        reflectSet: wrapTry((target, propertyKey, value) => {
          return toJSAbiValue(
            Reflect.set(fromJSAbiValue(target), propertyKey, fromJSAbiValue(value))
          )
        }),
  ...
  class RbExceptionFormatter {
    ...
    _format(error, vm, privateObject) {
      ...
      try {
        ...
        return this.formatString(className, message, [firstLine.toString(), restLines.toString()])
      } catch (e) {
        return this.formatString(className, message)
      }
    }
  ...
  const DefaultRubyVM = async (rubyModule, options = {}) => {
    var _a, _b
    const args = []
    const env = Object.entries((_a = options.env) !== null && _a !== void 0 ? _a : {}).map(
      ([k, v]) => `${k}=${v}`
    )
    const fds = [
    ...
    const printer = ((_b = options.consolePrint) !== null && _b !== void 0 ? _b : true)
      ? consolePrinter()
      : undefined
  ...
  const runRubyScriptsInHtml = async (vm) => {
    ...
    try {
      ...
      for (
        var _d = true,
          promisingRubyScripts_1 = __asyncValues(promisingRubyScripts),
          promisingRubyScripts_1_1;
        (promisingRubyScripts_1_1 = await promisingRubyScripts_1.next()),
          (_a = promisingRubyScripts_1_1.done),
          !_a;
        _d = true
      ) {
      ...
      try {
        if (!_d && !_a && (_b = promisingRubyScripts_1.return))
          await _b.call(promisingRubyScripts_1)
      } finally {
  ...
  exports.main = main
  // cause I want to host my own ruby.wasm file
  exports.compileWebAssemblyModule = compileWebAssemblyModule
  exports.DefaultRubyVM = DefaultRubyVM
  exports.mainWithRubyVM = mainWithRubyVM
})
